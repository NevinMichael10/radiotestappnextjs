              ...
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <path
                          fill="#fff"
                          d="M26.707 36V24.373h3.875l.582-4.523h-4.457v-2.887c0-1.309.363-2.202 2.239-2.202l2.39-.001V10.92a32.146 32.146 0 00-3.478-.178c-3.442 0-5.802 2.102-5.802 5.958v3.334h-3.893v4.523h3.893V36h4.651z"
                        />
                      </svg>
                      </span>
                    </div>
                  ...
                  <button onClick={() => handleSignIn('google')}
                    className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50 mb-5">
                    <span>
                      <svg
                        width="20"
                        height="20"
                  ...
                  <button onClick = { async () => await signIn('facebook')} className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                    <span>
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 48 48"
